...
static const httpd_uri_t post_slider_data = {
    .uri       = "/slider",
    .method    = HTTP_POST,
...
static const httpd_uri_t post_get_Wifi = {
    .uri       = "/getWifi",
    .method    = HTTP_POST,
...
void start_webserver(void)
{
    ...
    if (httpd_start(&server, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(server, &post_slider_data);
        httpd_register_uri_handler(server, &post_get_Wifi);
